            ...
            <footer className="container pb-3 pt-5">
                <div className="row">
                    ...
                    <div className="mt-3 col-sm-3 col-xs-12">
                        ...
                        <IconText icon="/images/sosmed/eva_facebook-outline.svg" text="Tickitz Cinema id"/>
                        <IconText icon="/images/sosmed/bx_bxl-instagram.svg" text="tickitz.id"/>
                        <IconText icon="/images/sosmed/eva_twitter-outline.svg" text="tickitz.id"/>
                        <IconText icon="/images/sosmed/feather_youtube.svg" text="Tickitz Cinema id"/>
                    </div>
                </div>
