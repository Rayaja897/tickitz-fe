  ...
  const handleAvailableSeat = async () => {
    try {
      ...
      const requestSeat = await axios.post(
        `https://tickitz-be.onrender.com/rayhan/movie/${slug}/seat`,
        {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const requestBooking = await axios.post(
        `https://tickitz-be.onrender.com/rayhan/ticket/seat`,
        {
          movieSlug: slug,
      ...
      if (requestBooking.data.data.paymentId) {
        const requestPayment = await axios.patch(
          `https://tickitz-be.onrender.com/rayhan/ticket/purchase/${requestBooking.data.data.paymentId}`,
          {},
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
